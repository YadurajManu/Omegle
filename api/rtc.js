// WebRTC signaling server for serverless environments
...
module.exports = async (req, res) => {
  ...
  // Only process POST requests for RTC signaling
  if (req.method !== 'POST') {
    res.statusCode = 200;
    res.setHeader('Content-Type', 'application/json');
    res.end(JSON.stringify({ status: 'RTC API is online', method: 'Use POST for RTC signaling' }));
    return;
  }
